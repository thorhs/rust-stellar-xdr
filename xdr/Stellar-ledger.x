 ...
 */
union StellarValueExt switch (StellarValueType v)
{
 ...
 */
union LedgerHeaderExt switch (int v)
{
case 0:
    void;
};
...
union BucketMetadataExt switch (int v)
{
case 0:
    void;
};
...
union TransactionHistoryEntryExt switch (int v)
{
case 0:
    void;
};
...
union TransactionHistoryResultEntryExt switch (int v)
{
case 0:
    void;
};
...
union LedgerHeaderHistoryEntryExt switch (int v)
{
case 0:
    void;
};
