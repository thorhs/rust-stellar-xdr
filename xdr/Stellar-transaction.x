...
*/
union TransactionExt switch (int v)
{
case 0:
    void;
};
...
union TransactionSignaturePayloadTaggedTransaction switch (EnvelopeType type)
{
...
struct PathPaymentResultSuccess
{
...
case PATH_PAYMENT_SUCCESS:
     PathPaymentResultSuccess success;
...
union ManageOfferSuccessResultOffer switch (ManageOfferEffect effect)
{
...
union TransactionResultExt switch (int v)
{
case 0:
    void;
};
